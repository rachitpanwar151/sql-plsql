CREATE OR REPLACE PACKAGE XXAWR_SALES_ORDER_PACKAGE_AWR AS
   /*******************************************************************************************************************
    * $Header         : @(#)
...
/********** DECLARING INITIALIZING GLOBAL VARIABLES ******************/
  ...
  ************************************************/
    ...
    *******************************************************************************************************************/
    ...
    TYPE xxawr_so_rec_type IS RECORD (
    RECORD_ID NUMBER,
    ...
    TYPE xxawr_so_table_type IS
        TABLE OF xxawr_so_rec_type INDEX BY BINARY_INTEGER;
    SO_CREATE_IN_AWR xxawr_so_table_type;
    SO_CREATE_OUT_AWR xxawr_so_table_type;
 

 
    TYPE xxawr_so_rec_type_line IS RECORD (
    RECORD_ID NUMBER,
    TEMP_CUST_PO_NUMBER number,
           uom_code                VARCHAR2(240),
            ordered_quantity        NUMBER,
    ...
    type xxawr_so_table_type_line is table
    of xxawr_so_rec_type_line index by binary_integer;
    so_line_in xxawr_so_table_type_line;
    so_line_out xxawr_so_table_type_line;
