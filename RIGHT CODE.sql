...
BEGIN
  ...
  BEGIN
      ...
      DBMS_OUTPUT.PUT_LINE('LOOP SAY PHLAY  '||LN_COUNT);

    FOR R_HEADER IN C_HEADER 
    LOOP
      BEGIN

       DBMS_OUTPUT.PUT_LINE('LOOP K ANDAR');
...
WHERE OOHA.ATTRIBUTE1=R_HEADER.SF_ORDER_ID 
...
END WRAPPER_PROCEDURE;
    ...
    *******************************************************************************************************************/
    ...
    PROCEDURE MAIN_PROCEDURE (
       ...
       WRAPPER_PROCEDURE(IN_P_OIC_INSTANCE_ID);
